...
For the <img src="https://render.githubusercontent.com/render/math?math=\Delta \Omega"> and <img src="https://render.githubusercontent.com/render/math?math=d_L"> we report also the uncertainties at the merger obtained from eq. (12-13). WE provide also the S/N for the full signal.
